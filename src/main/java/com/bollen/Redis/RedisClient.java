...
public class RedisClient {
    ...
    static {
        ...
        maxWaitMills = Long.parseLong(resourceBundle.getString("redis.pool.maxWaitMills"));
        host = resourceBundle.getString("redis.pool.host");
        port = Integer.parseInt(resourceBundle.getString("redis.pool.port"));
    }
    /**
     * 初始化非切片池
     */
    public final void initialPool()
    {
        // 池基本配置
     ...
     * 初始化切片池
     */
    public final void initialShardedPool()
    {
        // 池基本配置
        JedisPoolConfig config = new JedisPoolConfig();
        config.setMaxTotal(maxTotal);
    ...
    public final void closePools() {
        jedisPool.close();
        shardedJedisPool.close();
    }


    public final void keyOperate() {
    ...
    public final void stringOperate() {
    ...
    public final void sortedSetOperate() {
